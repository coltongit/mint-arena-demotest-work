...
static void UI_CinematicsMenu_Event( void *ptr, int event ) {
	...
	if( uis.demoversion || uis.demotestversion && ((menucommon_s*)ptr)->id == ID_CIN_END ) {
...
static void UI_CinematicsMenu_Init( void ) {
	...
	y += VERTICAL_SPACING;
	cinematicsMenuInfo.cin_demoend.generic.type			= MTYPE_PTEXT;
	cinematicsMenuInfo.cin_demoend.generic.flags		= QMF_CENTER_JUSTIFY|QMF_PULSEIFFOCUS;
	cinematicsMenuInfo.cin_demoend.generic.x			= 320;
	cinematicsMenuInfo.cin_demoend.generic.y			= y;
	cinematicsMenuInfo.cin_demoend.generic.id			= ID_CIN_DEMOEND;
	cinematicsMenuInfo.cin_demoend.generic.callback		= UI_CinematicsMenu_Event; 
	cinematicsMenuInfo.cin_demoend.string				= "DEMO END";
	cinematicsMenuInfo.cin_demoend.color				= text_big_color;
	cinematicsMenuInfo.cin_demoend.style				= UI_CENTER;
	...
	Menu_AddItem( &cinematicsMenuInfo.menu, &cinematicsMenuInfo.cin_demoend );
